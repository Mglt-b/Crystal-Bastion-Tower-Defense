...
title = Crystal Bastion TD

# (str) Package name
package.name = CrystalBastionTD

# (str) Package domain (needed for android/ios packaging)
package.domain = CrystalBastionTD.app
...
requirements = python3==3.10.6,hostpython3==3.10.6,kivy==master, android, jnius, https://github.com/kivymd/KivyMD/archive/master.zip
